...
public class CreateDAO {
	...
	private static void criarEntidadePedido(Conexao con, String schema) {
		...
		if (entidadeExists(con, schema, entidade)) {
			criarCampo(con, schema, entidade, "idpedido", "serial", false, false, null, null);
			criarCampo(con, schema, entidade, "codigo", "integer UNIQUE NOT NULL", true, false, null, null);
	...
	private static void criarEntidadeProdPedido(Conexao con, String schema) {
		...
		if (entidadeExists(con, schema, entidade)) {
			...
			criarCampo(con, schema, entidade, "codigo", "integer", false, true, "pedido", "codigo");
		}
	}
